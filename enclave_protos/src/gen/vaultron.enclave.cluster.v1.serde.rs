...
impl serde::Serialize for CreateUserWalletParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletParams", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateUserWalletParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.enclave.cluster.v1.CreateUserWalletParams")
            }
        ...
        deserializer.deserialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateUserWalletRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateUserWalletRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.enclave.cluster.v1.CreateUserWalletRequest")
            }
        ...
        deserializer.deserialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateUserWalletResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletResponse", len)?;
        if !self.wallet_encrypted_data.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateUserWalletResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.enclave.cluster.v1.CreateUserWalletResponse")
            }
        ...
        deserializer.deserialize_struct("vaultron.enclave.cluster.v1.CreateUserWalletResponse", FIELDS, GeneratedVisitor)
    }
}
