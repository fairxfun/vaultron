...
impl serde::Serialize for AttestationDocument {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.enclave.attestation.v1.AttestationDocument", len)?;
        if !self.module_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AttestationDocument {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.enclave.attestation.v1.AttestationDocument")
            }
        ...
        deserializer.deserialize_struct("vaultron.enclave.attestation.v1.AttestationDocument", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AttestationDocumentUserData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.enclave.attestation.v1.AttestationDocumentUserData", len)?;
        if !self.request.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AttestationDocumentUserData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.enclave.attestation.v1.AttestationDocumentUserData")
            }
        ...
        deserializer.deserialize_struct("vaultron.enclave.attestation.v1.AttestationDocumentUserData", FIELDS, GeneratedVisitor)
    }
}
