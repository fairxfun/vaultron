...
impl<'de> serde::Deserialize<'de> for ClientOptions {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.service.v1.ClientOptions")
            }
        ...
        deserializer.deserialize_struct("vaultron.service.v1.ClientOptions", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServerOptions {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("vaultron.service.v1.ServerOptions", len)?;
...
impl<'de> serde::Deserialize<'de> for ServerOptions {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct vaultron.service.v1.ServerOptions")
            }
        ...
        deserializer.deserialize_struct("vaultron.service.v1.ServerOptions", FIELDS, GeneratedVisitor)
    }
}
